 ...
 * @author GAMER PC
 */
public class VentanaSeleccionCliente extends javax.swing.JInternalFrame {
    ...
    public VentanaSeleccionCliente(VentanaFacturas ventanaFacturas, ControladorCliente controladorCliente) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "RUC", "Nombre", "Dirección", "Teléfono", "Cédula", "Nombre Propietario"
            }
        ) {
	...
	String ruc = jTable1.getValueAt(fila, 0)+"";
	ventanaFacturas.setCliente(ruc);
	this.dispose();
    ...
    private void formInternalFrameActivated(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameActivated
        controladorCliente.verClienteFactura((DefaultTableModel) jTable1.getModel());
